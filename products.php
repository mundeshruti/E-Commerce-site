...
<html>
    <head>
        ...
        <title> FashionFusion Store</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our  FashionFusion Store!</h1>
           ...
           <footer class="footer">
               <div class="container">
               <center>
               <p>"Shop smart, shop online."</p>
                <p>Copyright &copy FashionFusion All Rights Reserved. | Contact Us: +91 1234598760</p>
